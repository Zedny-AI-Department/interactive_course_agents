...
@data_processing_router.post("/generate-async",
...
async def create_generation_task(
    ...
    try:
        # Create task
        task_id = await task_manager.create_task(user_id, "generate_paragraphs_with_visuals")
...
@data_processing_router.post("/extract-pdf-visuals-async",
                             response_model=CreateTaskResponse)
async def create_pdf_visuals_task(
    ...
    try:
        # Create task
        task_id = await task_manager.create_task(user_id, "extract_and_align_pdf_visuals")
...
@data_processing_router.post("/extract-pdf-visuals-with-copyright-async",
                             response_model=CreateTaskResponse)
async def create_pdf_visuals_copyright_task(
    ...
    try:
        # Create task
        task_id = await task_manager.create_task(user_id, "extract_and_align_pdf_visuals_with_copyright_detection")
...
@data_processing_router.post(
    "/generate", response_model=EducationalContent
)
...
@data_processing_router.post(
    "/extract-pdf-visuals", response_model=EducationalContent
)
...
@data_processing_router.post(
    "/extract-pdf-visuals-with-copyright", response_model=EducationalContent
)
